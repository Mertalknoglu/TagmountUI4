...
class ResetPasswords{
    ...
    public function __construct(){
        ...
        $this->mail->Port = 587;
        $this->mail->Username = 'sukhasoftware@gmail.com';
        $this->mail->Password = '150901035Me';
    }
    ...
    public function sendEmail(){
        ...
        $url = 'http://localhost/tagmount/newpassword.php?selector='.$selector.'&validator='.bin2hex($token);
        ...
        $this->mail->setFrom('sukhasoftware@gmail.com','Tagmount');
